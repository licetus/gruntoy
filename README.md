...
├── docs/               ★ 交付文档（先读 01，再读 02；要动手开发原型直接读 06）
│   ├── 01-设计意图与核心目标.md
│   ├── 02-关键结构与模块边界.md
│   ├── 03-参数体系与校验规则.md
│   ├── 04-验证与交接说明.md
│   ├── 05-CHANGELOG-v1.0.md
│   └── 06-原型开发指南.md      ★ M1 概念原型逐日实操（含 v1.0 命令映射）
├── field-forms.html    ★ M1 现场记录表（14 张，可直接打印带到工作台）
...
| [`docs/06-原型开发指南.md`](docs/06-原型开发指南.md) | **要动手做原型就读这篇**：M1 门禁 7 项证据、14 天双线日程、逐日命令、判据汇总、常见坑 |
| [`field-forms.html`](field-forms.html) | M1 现场记录表 14 张，浏览器打开可直接填写与打印（A4） |
